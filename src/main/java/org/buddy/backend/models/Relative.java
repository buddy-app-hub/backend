...
public class Relative {
        ...
        private String relativeOfElderID;
        ...
        public String getRelativeOfElderID() {
            return relativeOfElderID;
        }
    
        public void setRelativeOfElderID(String relativeOfElderID) {
            this.relativeOfElderID = relativeOfElderID;
        }
        ...
        public String toString() {
            return "Elder{" +
                    ...
                    ", relativeOfElderID='" + relativeOfElderID + '\'' +
                    '}';
        }
    }